...
@interface MDSelectedListView ()<UITableViewDelegate , UITableViewDataSource>

@property (nonatomic , strong ) NSMutableArray *dataArray;

@end

@implementation MDSelectedListView
...
- (void)setArray:(NSArray<MDSelectedListModel *> *)array{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MDSelectedListModel *model = self.array[indexPath.row];
